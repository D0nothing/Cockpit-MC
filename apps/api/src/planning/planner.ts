...
function buildPrintMyMindPlan(input: PlannerInput): RequestPlan {
  const tickets: DeliveryTicketPlan[] = [
    ticket(
      ...
      [],
      [
        "Le parcours s’arrête au téléchargement STL ou 3MF",
        "Les décisions de prix, quota, conservation et authentification sont explicites",
        "Drac2Print reste un point d’intégration futur sans commande d’impression",
      ],
      [
    ...
    ticket(
      ...
      ["scope"],
      [
        "Les frontières web, API, workers, base, stockage et fournisseurs sont explicites",
        "Les secrets et données privées ne traversent aucune frontière cliente",
        "Le modèle de données préserve un futur transfert idempotent vers Drac2Print",
      ],
      [
        "Décision d’architecture versionnée",
        "Modèle de menace et flux réseau mis à jour",
      ],
      ["architecture-report"],
    ),
    ticket(
      ...
      ["architecture"],
      [
        "Le projet démarre avec configuration validée et migrations reproductibles",
        "Les entités utilisateur, abonnement, génération, asset et webhook sont persistées",
      ],
      [
    ...
    ticket(
      ...
      [
        ...
        "GLB, STL, 3MF, miniatures et originaux possèdent checksum et propriétaire",
        "Les téléchargements utilisent des URLs signées courtes",
      ],
      [
        "Tests d’isolation entre utilisateurs ajoutés",
    ...
    ticket(
      ...
      [
        "POST /generations répond 202 avec une ressource persistée",
    ...
    ticket(
      "secure-download",
      "printability-export",
      "Sécuriser le téléchargement des exports",
      input.objective,
      "implementation",
      "security",
      "small",
      ...
      [
        ...
        "Le téléchargement clôt le parcours MVP sans commande d’impression",
      ],
      [
        "Tests IDOR et expiration réussissent",
    ...
    ticket(
      ...
      [
        "Le parcours inscription vers téléchargement STL et 3MF réussit",
    ...
    ticket(
      ...
      [
        ...
        "Aucun merge, déploiement ou transfert Drac2Print n’est automatique",
      ],
      [
  ...
  return parseRequestPlan({
    ...
    epics: [
      ...
      epic(
        ...
        "Transformer un modèle généré en fichier dimensionné et téléchargeable avec un risque explicite.",
        "Un résultat analysé ou réparé peut être exporté en STL ou 3MF via un lien privé.",
        [
